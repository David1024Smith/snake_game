...
class SimpleSnakeGame(QObject):
    ...
    def update_game(self):
        ...
        if new_head == self._food_position:
            ...
            self._spawn_food()
            self.scoreChanged.emit(self._score)
            print(f"Food eaten! Score: {self._score}")
...
def main():
    ...
    # 注册QML类型
    qmlRegisterType(SimpleSnakeGame, "SnakeGame", 1, 0, "SimpleSnakeGame")
    
    # 创建游戏引擎
    game_engine = SimpleSnakeGame()
            ...
            Row {
                ...
                Rectangle {
                    ...
                    Rectangle {
                        ...
                        color: "#80000000"
                        radius: 10
                        visible: gameEngine.gameState === "menu"
                    ...
                    Rectangle {
                        ...
                        color: "#80000000"
                        radius: 10
                        visible: gameEngine.gameState === "paused"
                    ...
                    Rectangle {
                        ...
                        color: "#80000000"
                        radius: 10
                        visible: gameEngine.gameState === "game_over"
